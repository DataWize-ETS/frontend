        ...
        <div className="info-main">
            <div className="list-info">
                <ul>
                    ...
                    <li>If it has the correct information it will be approved by the administrator and you will be able to view it in <a id="link" href="https://www.atlassian.com/software/jira">Jira</a></li>
                </ul>
